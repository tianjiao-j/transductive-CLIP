...
#   do
#   python main.py --opts shots ${shot} dataset ${dataset} batch_size 100 number_tasks 1000 use_softmax_feature True backbone RN50 method ${method}
#   done
# done
...
do
  ...
  for shot in 16 8 4 2 1
  do
  python main.py --opts shots ${shot} dataset ${dataset} batch_size 2 number_tasks 1000 use_softmax_feature True backbone RN50 method ${method}
  done
done